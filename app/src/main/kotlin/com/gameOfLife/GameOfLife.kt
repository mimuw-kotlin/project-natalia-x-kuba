...
fun main() =
    runBlocking {
        ...
        // Initialize two coroutines for the timer and ads, ensuring they run concurrently
        val threadTimer = coroutineScope.launch { Timer.run() }
        val threadAdManager = coroutineScope.launch { AdManager.run() }
